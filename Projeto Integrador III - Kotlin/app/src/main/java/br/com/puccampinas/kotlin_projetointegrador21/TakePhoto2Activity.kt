...
import br.com.puccampinas.kotlin_projetointegrador21.databinding.ActivityTirarFotoCliente2Binding
...
class TakePhoto2Activity : AppCompatActivity() {

    // Declaração da variável para o binding da ActivityTirarFotoCliente2
    private lateinit var binding: ActivityTirarFotoCliente2Binding
    ...
    // Variáveis para armazenar o caminho das imagens no Firebase Storage
    private lateinit var imagemBucketStorageTwo: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        // Inicializa o binding com o layout da ActivityTirarFotoCliente2
        binding = ActivityTirarFotoCliente2Binding.inflate(layoutInflater)
        ...
        // Obtém os dados do documento de locação e a primeira imagem passados pela intent
        hireDocumentdata = intent.getStringExtra("hiredId")
        Log.d("Dados Recebidos", "hireDocumentId: $hireDocumentdata")
        imagemBucketStorageOne = intent.getStringExtra("imageLoc1").toString()
        ...
        fun addOnFirebase() {
            val locacao = hashMapOf(
                ...
                "plano" to plano,
                "userEmail" to userId,
                "image1" to imagemBucketStorageOne,
                "image2" to imagemBucketStorageTwo
            )
    ...
    // Função para navegar para a atividade NFC_LINKActivity
    private fun viewNFCAct(hiredDocumentdata: String) {
        val intentNFC = Intent(this, NFC_LINKActivity::class.java)
        intentNFC.putExtra("hiredId", hiredDocumentdata)
